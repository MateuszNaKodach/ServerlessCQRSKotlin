...
abstract class FunctionBase {
    ...
    init{
        ...
        val cancelReservationCommandHandler = CancelReservationCommandHandler(AggregateFactory(Reservation::class, eventStoreClient), eventStoreClient)
        bus.registerCommandHandler(CancelReservation::class.simpleName, cancelReservationCommandHandler::handle)
